...
export const project: Attachment[] = [
	{
		...
		description:
			"Kawan Lama E-Recruitment merupakan website karir yang mengelola proses rekrutmen kandidat karyawan Kawan Lama Group",
	...
	},
	{
		...
		description:
			"Kawan Lama Academy merupakan platform pembelajaran bagi for 30.000+ karyawan internal Kawan Lama Group",
		...
		tech: ["Nuxt JS (Vue)", "Shadcn (Tailwind)", ".NET Core"],
	},
	{
		id: "PRJ003",
		...
		name: "POSnova",
		description:
			"POSnova adalah aplikasi Point of Sales berbasis website dengan sistem rekomendasi berbasis AI",
