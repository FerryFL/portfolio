		...
		>
			<div className=" flex gap-2 font-bold text-4xl md:text-5xl justify-center">
				<span
					data-aos="fade-up"
					data-aos-delay="200"
					className="relative pb-2 inline-block bg-custom-linear-cyan bg-clip-text text-transparent"
				>
					About Me
				</span>
			</div>
			...
			<div className="flex flex-1 flex-col md:flex-row w-full items-center justify-center gap-10 py-5">
				<div className="flex flex-col flex-1 gap-6 order-2 md:order-1">
					...
					<div
						data-aos="fade-up"
						data-aos-delay="200"
						className="flex gap-2 px-6 py-4 w-full border border-white/10 rounded-full"
					>
						<Quote className="text-gray-700" />
						<span className="italic">{`"Motivation gets you going, but discipline keeps you growing"`}</span>
					</div>
					<div
						data-aos="fade-up"
						data-aos-delay="200"
					...
					>
						<Button
							...
							variant="gradient"
							size="lg"
							className="text-white/70 group hover:scale-105 duration-300"
							asChild
						>
							<a
