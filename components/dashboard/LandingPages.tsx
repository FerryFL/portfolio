				...
				<div className="relative">
					...
					>
						...
						{TECH_STACK.map((tech, index) => (
							<div
								key={index}
								className="px-4 py-2 inline-block rounded-full bg-white/5 hover:bg-white/10 hover:scale-105 border border-white/10 text-gray-300 transition-all duration-300 hover:shadow"
							>
