...
const Contact = () => {
	return (
		<div
			id="Contact"
			className="w-full min-h-96 flex flex-col px-[5%] lg:px-[10%] py-10"
		>
			...
			<div
				data-aos="fade-up"
				data-aos-delay="400"
				className="w-full flex flex-wrap gap-4 justify-center pt-5"
			>
				...
				<Card className="w-80 bg-transparent border border-cyan-700/60 hover:scale-105 duration-300">
					<div className="flex flex-col items-center gap-2">
						...
						<span className="text-white/80">
							www.linkedin.com/in/ferry-febrian-it/
						</span>
					</div>
				</Card>
			</div>
